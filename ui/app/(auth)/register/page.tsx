    ...
    if (verificationSent) {
        return (
            <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 p-4">
                <div className="max-w-md w-full bg-white p-10 rounded-2xl shadow-xl text-center space-y-6 border border-slate-100">
                    ...
                    <div className="pt-4 space-y-3">
                        <Link href="/login">
                            <Button className="w-full bg-slate-900 hover:bg-slate-800 text-white rounded-md h-10">
                                Back to Login
                            </Button>
                        </Link>
