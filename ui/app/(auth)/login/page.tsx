            ...
            <div className="w-full max-w-[1000px] h-[600px] bg-white rounded-2xl shadow-xl overflow-hidden flex border border-slate-100">
                ...
                <div className="hidden lg:flex w-1/2 bg-slate-800 flex-col justify-between p-12 text-white relative overflow-hidden">
                    <div className="z-10">
                        ...
                        <p className="text-slate-300 text-sm font-medium">People-first HR tools that scale.</p>
                    </div>

                    <div className="z-10 relative">
                        <div className="absolute -left-4 -top-6 text-6xl text-slate-600/50 font-serif">"</div>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center font-bold text-sm text-slate-200">SD</div>
                            <div>
                                <div className="font-semibold text-white">Sofia Davis</div>
                                <div className="text-xs text-slate-300 uppercase tracking-wider">VP of Operations</div>
                            </div>
                        </div>
                    </div>

                    <div className="z-10 text-xs text-slate-300/80 space-y-1">
